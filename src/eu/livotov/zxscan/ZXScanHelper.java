...
/**
 * Created with IntelliJ IDEA. User: dlivotov Date: 26.08.12 Time: 21:14 To
...
public class ZXScanHelper {
	...
	// private static boolean blockCameraRotation = false;
...
//	public final static void getFragmentIntentScan(Fragment frag, int requestCode) {
	...
	private static Intent getExternalApplicationIntent(final Context ctx) {
		...
		for (ResolveInfo availableApp : availableApps) {
			...
			if (!TextUtils.isEmpty(packageName)) {
				if (packageName.contains("com.google.zxing.client.android")
						|| packageName.contains("com.srowen.bs.android")) {
					return intent;
				}
			}
		}
