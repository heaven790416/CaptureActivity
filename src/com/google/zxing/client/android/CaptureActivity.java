...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback {
	...
	public static int currentOrientation; // fix orientation
	...
	public void onCreate(Bundle icicle) {
		...
		// ZXScanHelper.isBlockCameraRotation())
		// {
...
//				Toast.makeText(CaptureActivity.this, "Scan", Toast.LENGTH_LONG).show();
//				// finish();
//			}
//		});
		hasSurface = false;
	...
	protected void onResume() {
		...
		decodeFormats = DecodeFormatManager.QR_CODE_FORMATS; // todo: read from
																// helper
		characterSet = "utf-8";
	...
	private void displayFrameworkBugMessageAndExit(Throwable err) {
		...
		builder.setMessage(
				getString(R.string.zx_unexpected_camera_error, err.getClass().getName() + ": " + err.getMessage()));
	...
	/**
	 * @author Edward Lo(edward0312@gmail.com)
	 * @return
	 */
	public int setCurrentOrientation() {
		// Configuration configuration = getResources().getConfiguration();
		// currentOrientation = configuration.orientation;

		currentOrientation = getWindowManager().getDefaultDisplay().getRotation();
